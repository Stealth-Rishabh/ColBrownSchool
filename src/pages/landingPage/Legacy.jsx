...
export default function Legacy() {
  return (
    <section className="bg-green-950">
      <Container>
        <div className="grid gap-8 lg:grid-cols-2 lg:gap-24 items-start">
          ...
          <div className="grid gap-8 md:grid-cols-2">
            ...
            <div className="space-y-2">
              <h2 className="text-xl font-semibold text-white">Educational Philosophy</h2>
              <p className="text-gray-300 sm:text-lg dark:text-gray-200">
        ...
        <div className="aspect-square bg-gray-800 rounded-lg overflow-hidden drop-shadow-lg">
          <img
            src={img1}
